  ...
  <div>
    ...
    <div v-for="post in posts.data" :key="post.id" class="
      ...
      <div class="flex flex-shrink-0 p-4 pb-0">
        <div class="flex-shrink-0 group block">
          <div class="flex items-top">
            <div>
              <InertiaLink v-if="$page.props.user !== null" :href="route('user-profile', { id: post.username })">
                <img class="inline-block h-9 w-9 rounded-full" :src="post.avatar" alt="" />
              </InertiaLink>
              <InertiaLink v-if="$page.props.user === null" :href="post.link">
                <img class="inline-block h-9 w-9 rounded-full" :src="post.avatar" alt="" />
              </InertiaLink>
            </div>
            <div class="ml-3">
      ...
      <div class="pl-16">
        ...
        <div v-if="post.media !== 'storage/'" class="flex mb-4 mr-2 rounded-2xl border border-gray-600 w-fit">
